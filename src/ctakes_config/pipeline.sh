...
cd $CTAKES_HOME
java -Dctakes.umlsuser= -Dctakes.umlspw= -cp $CTAKES_HOME/lib/*:$CTAKES_HOME/desc/:$CTAKES_HOME/resources/ -Dlog4j.configuration=file:$CTAKES_HOME/config/log4j.xml -Xms1g -Xmx2g org.apache.ctakes.ytex.tools.RunCPE $CTAKES_HOME/desc/ctakes-clinical-pipeline/desc/collection_processing_engine/test_plaintext_auto.xml
